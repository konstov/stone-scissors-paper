...
# подготовка ответов
def prepare_answers(bot_choice, bot_choice_text_for_speech, is_looser, round_result, is_limit):
...
def help_answer():
    text = """
        ...
        Чтобы играть матч до заданного числа побед, скажите "Играть до 3 побед". Число может быть любым!
        Для прерывания матча скажите "Прервать матч" или "Остановить матч". 
        
        Чтобы сыграть в камень, ножницы, бумага, ящерица, Спок, скажите "Cложная игра".
        В этом режиме добавляются ящерица 🐉 и Спок 👽.
        
        Правила этого режима доступны по команде "Как играть в сложную игру"?
...
def lizard_spock_rules():
    text = """
    Правила камень, ножницы, бумага, ящерица, Спок, такие:
    ...
    tts = 'Правила - камень - , ножницы - , бумага - , ящерица - , Спок - ,  такие : \
        Камень давит ящерицу и затупляет ножницы - - . \
        Ножницы режут бумагу и обезглавливают ящерицу - - бедное животное - - . \
        Бумага опровергает Спока и оборачивает камень - - . \
        Ящерица поедает бумагу и отравляет Спока - - . \
...
def add_lizard_spock():
    ...
    Напомню, что правила можно узнать по команде "Как играть в сложную игру?"
    """

    tts = 'Ух ты! - Вы решили сыграть в камень, -  ножницы,  - бумага, - ящерица, - Спок! - \
          Напомню, что правила можно узнать по команде - - как - играть - в - сложную - игр+у ? '
...
def remove_lizard_spock():
    ...
    tts = 'Возвращаемся к стандартному варианту игр+ы. - \
...
def already_simple_game():
    ...
    tts = 'Да, - - как скажете,  - - продолжим играть в простой вариант игр+ы без ящерицы и Спока - \
          Чтобы сыграть с ними, скажите  - - сложная игра. '
...
def new_limit_game_invitation():
    text = """
    Скажите "да", чтобы повторить матч сначала, или "нет", чтобы вернуться к обычной игре.
    """

    tts = 'Скажите - да - , чтобы повторить матч сначала, или  - нет - , чтобы вернуться к обычной игр+е. '
...
def interrupt_limit_game():
    text = """
    Не проблема! Возвращаемся к несоревновательному варианту.
    """

    tts = 'Не проблема! Возвращаемся к несоревновательному варианту. '

    return text, tts

def already_interrupt_limit_game():
    text = """
    Хорошо, продолжаем играть несоревновательный вариант игры.
    """

    tts = 'Хорошо, - продолжаем играть несоревновательный вариант игр+ы. '
